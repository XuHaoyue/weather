$(function () {
    ...
    function render() {
        ...
        $("#tomorrow img").attr({"src":`img/${weather.tomorrow_weather_icon_id}.png`});
        ...
        let str=`<li>
            <p class="date">${element.date.slice(5,7)}/${element.date.slice(8,10)}</p>
            <p class="txtmaxwea">${element.condition.slice(0,2)}</p>
            <img src="img/${element.weather_icon_id}.png" alt="">
            <p class="maxwendu">${element.high_temperature}°</p>
            <p class="minwendu">${element.low_temperature}°</p>
            <img src="img/${element.weather_icon_id}.png" alt="">
            <p class="txtminwea">${element.condition}</p>
            <p class="windpower">${element.wind_direction}<br>${element.wind_level}级</p>
        </li>`
